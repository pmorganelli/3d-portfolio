  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-blue-800">Peter</span></h1>
          <p className={`${styles.heroSubText}`}>
          I'm a full-stack developer and computer science student at  
          <br className="sm:block-hidden"/> Tufts University. Please reach out if you'd like to connect!
          </p>
        </div>
      </div>
        <ComputersCanvas />
